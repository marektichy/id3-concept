...
## Foreword
People are scared of reading whitepapers and many are indeed quite complicated. But this one is really a simple one. Anyone who can understand what a "triangle" is can grasp the idea, so please carry on reading, it's short. And "if you see [a](https://en.wikipedia.org/wiki/Row,_Row,_Row_Your_Boat) crocodile, don't forget to scream" (or [a](https://en.wikipedia.org/wiki/Elephant_in_the_room)  domesticated elephant).
