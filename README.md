...
## Foreword
People are scared of reading whitepapers and many are indeed quite complicated. But this one is really a simple one. Anyone who can understand what a "triangle" is can grasp the idea, so please carry on reading, it's short. And ["](https://en.wikipedia.org/wiki/Row,_Row,_Row_Your_Boat) if you see a crocodile, don't forget to scream["](https://en.wikipedia.org/wiki/Row,_Row,_Row_Your_Boat) (or [a](https://en.wikipedia.org/wiki/Elephant_in_the_room)  domesticated elephant).
